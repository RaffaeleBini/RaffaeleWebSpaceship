...
- **Web3Forms**: chiave reale aggiunta alle Environment Variables di Vercel dall'utente, rebuild fatto col push del focus trap/OG image, percorso `sending → sent` testato dall'utente sul sito deployato e confermato funzionante. **"Sviluppo/tecnico" ora completo.**

Restano da fare: dominio/DNS (sospeso su richiesta esplicita), case study reali, conferma numeri pubblici, test su telefono fisico.
