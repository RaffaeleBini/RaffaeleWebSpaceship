...
Home/About/Skills/Experience non usano più il placeholder "Blocco 3"; Projects/Contact/Log restano placeholder (Blocchi 4, 5, fase 2). Home ha due CTA (`REQUEST A BRIEFING` → Contact, `VIEW MY WORK` → Projects) tramite `onNavigate` passato da `Hud.tsx`. Nessun form, dossier modale o i18n IT/ES implementati — Blocchi 4-7, vedi `design/NEXT-STEPS.md` §3.
