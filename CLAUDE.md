...
Contact non usa più il placeholder. Log resta placeholder (fase 2, non un blocco NEXT-STEPS separato). Nessun i18n IT/ES implementato — vedi `design/NEXT-STEPS.md` §3 (Blocco 6 mobile, Blocco 7 rifiniture restano da fare).
